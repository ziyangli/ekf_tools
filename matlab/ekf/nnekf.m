...
%   x), nx and the number of output (size of y), ny. The equation of the NN
...
%   values.
%   R: the measurement covariance, dependent on the noise level of data, tunable. 
%
...
% the NN model
y       = W2(:, 1:nh)*tanh(W1(:, 1:nx)*x + W1(:, nx + ones(1, N))) ...
          + W2(:, nh + ones(1, N));
